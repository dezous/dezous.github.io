(() => {
    ...
    (() => {
        ...
        const iti = intlTelInput(input, {
            ...
            initialCountry: "pl",
            preferredCountries: [ "pl", "ua", "us", "de", "fr" ],
            separateDialCode: false,
            nationalMode: false,
            autoPlaceholder: "polite",
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                } else if (formRequiredItem.type === "tel") if (!iti.isValidNumber()) {
                    this.addError(formRequiredItem);
                    this.removeSuccess(formRequiredItem);
                    error++;
                } else {
            ...
            addError(formRequiredItem) {
                if (formRequiredItem.id === "phone") {
                    let parentPhone = formRequiredItem.parentElement;
                    formRequiredItem.classList.add("_form-error");
                    parentPhone.parentElement.classList.add("_form-error");
                } else {
                    formRequiredItem.classList.add("_form-error");
            ...
            removeError(formRequiredItem) {
                if (formRequiredItem.id === "phone") {
                    ...
                    parentPhone.parentElement.classList.remove("_form-error");
                } else {
                    formRequiredItem.classList.remove("_form-error");
            ...
            emailTest(formRequiredItem) {
                ...
                return !emailRegex.test(formRequiredItem.value);
            }
        };
        ...
        function initSliders() {
            if (document.querySelector(".offer__slider")) new swiper_core_Swiper(".offer__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".offer__controls_pagination",
                    clickable: true
                },
                navigation: {
                    nextEl: ".offer__controls_button--next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
        ...
        const updateCounter = (textarea, counter) => {
            ...
            counter.textContent = maxLength >= 0 ? `${valueLength}/${maxLength}` : valueLength;
        };
        const initializeCounter = textarea => {
            const counter = document.createElement("div");
            counter.classList.add("textarea-box__counter");
            textarea.insertAdjacentElement("afterend", counter);
            updateCounter(textarea, counter);
            textarea.addEventListener("input", (() => updateCounter(textarea, counter)));
        };
        const resizeTextArea = (textarea, grab) => {
            ...
            document.addEventListener("mousemove", (e => {
                ...
                if (newHeight <= 90) textarea.style.height = `90px`; else textarea.style.height = `${newHeight}px`;
            }));
        ...
        document.querySelectorAll("textarea").forEach(initializeCounter);
        document.querySelectorAll("textarea").forEach((textarea => {
            const parent = textarea.parentElement;
            const customGrab = parent.querySelector(".textarea-box__handle");
            if (customGrab && customGrab != null) resizeTextArea(textarea, customGrab);
        }));
        window["FLS"] = true;
        menuInit();
        formFieldsInit({
